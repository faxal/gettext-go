...
// PoHeader is the initial comments "SOME DESCRIPTIVE TITLE", "YEAR"
...
type PoHeader struct {
	Comment                 PoComment // Header Comments
...
func (p *PoHeader) parseHeader(entry *PoEntry) {
